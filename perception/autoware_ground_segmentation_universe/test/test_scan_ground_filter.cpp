...
protected:
  void SetUp() override
  {
    ...
    scan_ground_filter_ =
      std::make_shared<autoware::ground_segmentation_universe::ScanGroundFilterComponent>(options);

    // read pcd to pointcloud
    sensor_msgs::msg::PointCloud2::SharedPtr origin_input_msg_ptr =
      std::make_shared<sensor_msgs::msg::PointCloud2>();
    const auto share_dir =
      ament_index_cpp::get_package_share_directory("autoware_ground_segmentation_universe");
...
public:
  std::shared_ptr<autoware::ground_segmentation_universe::ScanGroundFilterComponent> scan_ground_filter_;
